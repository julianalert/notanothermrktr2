...
import authorImage from '@/images/julien.jpeg'
        ...
        <div className="bg-slate-50 pt-px sm:rounded-6xl">
          ...
          <div className="px-4 py-10 sm:px-10 sm:py-16 md:py-20 lg:px-20 lg:py-32">
            ...
            <p className="mt-8 font-display text-5xl font-extrabold tracking-tight text-slate-900 sm:text-6xl">
              {/* <span className="block text-blue-600">Not Another Marketer</span> */} I’m Julien, aka <span className="block text-blue-600">Not Another Marketer</span> 
            </p>
            <p className="mt-4 text-lg tracking-tight text-slate-700">
              I'm the{' '}
              <Link
                href="https://www.linkedin.com/in/juliendevoir/"
                target="_blank"
            ...
            <p className="mt-8">
              ...
              >
                ...
                <span className="ml-4">Join me on X</span>
              </Link>
            </p>
          </div>
        </div>
